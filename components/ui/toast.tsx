...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed inset-x-0 bottom-0 z-[100] flex max-h-screen flex-col-reverse items-center gap-2 p-4 sm:bottom-4 sm:right-4 sm:left-auto sm:items-end",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-xs text-muted-foreground dark:text-gray-400", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-full p-1 text-muted-foreground hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring dark:text-gray-400 dark:hover:bg-gray-800",
      className
    )}
    toast-close=""
    {...props}
