    ...
    <>
      ...
      <Dialog open={deleteStep1Open} onOpenChange={setDeleteStep1Open}>
        <DialogContent className="dark:bg-gray-900 dark:border-gray-800">
          <DialogHeader>
            <DialogTitle className="dark:text-gray-100">Permanently delete listing?</DialogTitle>
            <DialogDescription className="dark:text-gray-400">
              This removes the listing and related jobs, messages, and bids. It cannot be undone.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      <Dialog open={deleteStep2Open} onOpenChange={(o) => !o && setDeleteStep2Open(false)}>
        <DialogContent className="dark:bg-gray-900 dark:border-gray-800">
          <DialogHeader>
            ...
            <DialogDescription className="dark:text-gray-400">
              Type <strong>DELETE</strong> to permanently remove this listing and its related data.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            <Label htmlFor="delete-listing-confirm" className="dark:text-gray-300">
              Type DELETE
            </Label>
            <Input
              id="delete-listing-confirm"
              value={deleteConfirm}
