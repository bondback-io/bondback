/**
 * Full in-app help article content. Used when DB is empty or for slug lookup fallback.
 * Keeps Help & Support fully functional without database.
 */
...
export const FULL_HELP_ARTICLES: HelpArticleContent[] = [
  {
    id: "what-is-bond-back",
...
- Mention if the property manager will do a final inspection and what they check — this is standard for Australian bond returns.`,
  ...
  {
    id: "set-reserve-price-and-duration",
...
- If no bid meets your expectations, you can let the auction end and **relist** with adjusted reserve or duration, or contact support.`,
  ...
  {
    id: "approve-completion-release-funds",
...
- Keep records for your **tax and ABN** — the fee is a business cost.`,
  ...
  {
    id: "what-happens-dispute-opened",
...
/** Map slug → article for fast lookup when DB is empty or article not found. */
export const FULL_ARTICLES_BY_SLUG: Record<string, HelpArticleContent> = Object.fromEntries(
  FULL_HELP_ARTICLES.map((a) => [a.slug, a])
);
