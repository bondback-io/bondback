...
export const LISTING_FULL_SELECT =
  "id, lister_id, title, description, suburb, postcode, property_type, bedrooms, bathrooms, addons, special_instructions, move_out_date, photo_urls, initial_photos, cover_photo_url, reserve_cents, buy_now_cents, starting_price_cents, current_lowest_bid_cents, duration_days, status, end_time, created_at, platform_fee_percentage, cancelled_early_at";
