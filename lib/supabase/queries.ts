...
export const JOB_ADMIN_TABLE_SELECT =
  "id, listing_id, lister_id, winner_id, status, agreed_amount_cents, cleaner_bonus_cents_applied, created_at, completed_at, auto_release_at, cleaner_confirmed_at, lister_escrow_cancelled_at, lister_escrow_cancel_fee_cents, lister_escrow_cancel_refund_cents, lister_escrow_cancel_reason";
...
export const PROFILE_LISTER_DASHBOARD_SELECT =
  "id, roles, active_role, full_name, phone, suburb, created_at, stripe_connect_id, stripe_onboarding_complete, launch_promo_lister_jobs_used, launch_promo_cleaner_jobs_used, free_tier_airbnb_recurring_month_key, free_tier_airbnb_recurring_jobs_used, cleaner_promo_jobs_used, cleaner_promo_start_date";
